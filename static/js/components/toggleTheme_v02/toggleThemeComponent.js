...
customElements.define("toggle-theme-v02", class extends HTMLElement {
  constructor() {
    super();
  ...
  handleIconClick(event) {
    if (event.detail.id === 'moon') {
      if (this.shadowRoot != null) {
        this.shadowRoot.querySelector('icon-moon')?.setAttribute('data-active', 'false');
        this.shadowRoot.querySelector('icon-sun')?.setAttribute('data-active', 'true');
        document.documentElement.setAttribute('data-theme', 'dark');
      }
    }
    if (event.detail.id === 'sun') {
      if (this.shadowRoot != null) {
        this.shadowRoot.querySelector('icon-moon')?.setAttribute('data-active', 'true');
        this.shadowRoot.querySelector('icon-sun')?.setAttribute('data-active', 'false');
 ...
 */
customElements.define("icon-sun", class extends HTMLElement {
  /**
 ...
 * It includes functionality for event handling, attribute observation, and rendering the icon.
 */
customElements.define("icon-moon", class extends HTMLElement {
  /**
